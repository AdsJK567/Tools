...
Update_Shell() {
    ...
    # 获取最新版本号
    sh_new_ver=$(wget --no-check-certificate -qO- "https://raw.githubusercontent.com/AdsJK567/Tools/main/Script/trojan-install.sh" | grep 'sh_ver="' | awk -F "=" '{print $NF}' | sed 's/\"//g' | head -1)
    # 最新版本无需更新
    ...
    while true; do
        ...
        case $confirm in
            [Yy]* )
                ...
                wget -O trojan-install.sh --no-check-certificate https://raw.githubusercontent.com/AdsJK567/Tools/main/Script/trojan-install.sh
...
Install() {
    ...
    wget -O "$SYSTEM_FILE" https://raw.githubusercontent.com/AdsJK567/Tools/main/Service/trojan-go.service && chmod 755 "$SYSTEM_FILE"
...
Configure() {
    ...
    Check_install
    # 下载基础配置文件
    CONFIG_URL="https://raw.githubusercontent.com/AdsJK567/Tools/main/Config/trojan.json"
