...
Update_Shell() {
    ...
    # 获取最新版本号
    sh_ver_url="https://gh-proxy.com/https://raw.githubusercontent.com/AdsJK567/Tools/main/Script/mihomo/mihomo-cdn.sh"
...
Install() {
    ...
    bash <(curl -Ls https://gh-proxy.com/https://raw.githubusercontent.com/AdsJK567/Tools/main/Script/mihomo/install-cdn.sh)
}
...
Main() {
    ...
    echo -e "${Green}选项7，可以修改你的机场订阅链接${Reset}"
